    ...
    <div class="menu-container">
        ...
        <section class="mand-container">
            <form action="ctrlMandjeAfrekenen.php" method="post">
                ...
                <h3 class="mand-titel">Bestelling
                ...
                if (isset($_SESSION["mandje"]) && !empty($_SESSION["mandje"])): ?>
                    <div class="bestelling-container">
                        <?php foreach ($_SESSION["mandje"] as $pizzaId => $aantal):
                        ...
                        ?>
                                    <div class="mand-item">
                                        ...
                                        <div class="plusMin">
                                            <a href="ctrlIndexPizzas.php?remove=<?= $pizzaId ?>" class="fa fa-minus minus"></a>
                                            <a href="ctrlIndexPizzas.php?add=<?= $pizzaId ?>" class="fa fa-plus plus"></a>
                                        </div>
                                    </div>
                        <?php endif;
                            endforeach;
                        ...
                        <div class="totaal">Totaal €<?= number_format($tot, 2); ?></div>
                        <div style="text-align: center;"><input type="submit" value="Afrekenen" name="afrekenen"></div>
                    </div>
